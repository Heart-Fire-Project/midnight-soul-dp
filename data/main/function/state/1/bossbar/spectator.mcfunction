...
execute if score $1_process countdown matches 0..60 run bossbar set midsoul:info name {"translate":"ms.bossbar.s1.show","fallback":"流程结束中 » 预计 %s 秒后开始","with":[{"score":{"objective":"temp2","name":"$sec"}}]}