...
execute unless entity @e[tag=open_purple] run playsound entity.warden.emerge player @a[team=!admin] 0 1000000 0 1000000
execute if entity @e[tag=open_purple] run playsound event.mob_effect.bad_omen player @a[team=!admin] 0 1000000 0 1000000
