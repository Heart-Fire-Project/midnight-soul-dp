...
# 设置名称
execute if score $ms temp2 matches ..09 run bossbar set midsoul:info name [{"translate":"ms.bossbar.4.portal","fallback":"传送门 »","color":"aqua"}," ",{"score":{"objective":"temp2","name":"$sec"},"color":"#50A7D9"},{"text":".0","color":"#50A7D9"},{"score":{"objective":"temp2","name":"$ms"},"color":"#50A7D9"}," ",{"translate":"ms.bossbar.4.portal.2","fallback":"« 已出现"}]
execute if score $ms temp2 matches 10.. run bossbar set midsoul:info name [{"translate":"ms.bossbar.4.portal","fallback":"传送门 »","color":"aqua"}," ",{"score":{"objective":"temp2","name":"$sec"},"color":"#50A7D9"},{"text":".","color":"#50A7D9"},{"score":{"objective":"temp2","name":"$ms"},"color":"#50A7D9"}," ",{"translate":"ms.bossbar.4.portal.2","fallback":"« 已出现"}]
execute if score $ms temp2 matches ..09 run bossbar set midsoul:heed name [{"translate":"ms.bossbar.4.portal","fallback":"传送门 »","color":"yellow"}," ",{"score":{"objective":"temp2","name":"$sec"},"color":"gold"},{"text":".0","color":"gold"},{"score":{"objective":"temp2","name":"$ms"},"color":"gold"}," ",{"translate":"ms.bossbar.4.portal.2","fallback":"« 已出现"}]
execute if score $ms temp2 matches 10.. run bossbar set midsoul:heed name [{"translate":"ms.bossbar.4.portal","fallback":"传送门 »","color":"yellow"}," ",{"score":{"objective":"temp2","name":"$sec"},"color":"gold"},{"text":".","color":"gold"},{"score":{"objective":"temp2","name":"$ms"},"color":"gold"}," ",{"translate":"ms.bossbar.4.portal.2","fallback":"« 已出现"}]
execute if score $ms temp2 matches ..09 run bossbar set midsoul:warn name [{"translate":"ms.bossbar.4.portal","fallback":"传送门 »","color":"red"}," ",{"score":{"objective":"temp2","name":"$sec"},"color":"#E80505"},{"text":".0","color":"#E80505"},{"score":{"objective":"temp2","name":"$ms"},"color":"#E80505"}," ",{"translate":"ms.bossbar.4.portal.2","fallback":"« 已出现"}]
execute if score $ms temp2 matches 10.. run bossbar set midsoul:warn name [{"translate":"ms.bossbar.4.portal","fallback":"传送门 »","color":"red"}," ",{"score":{"objective":"temp2","name":"$sec"},"color":"#E80505"},{"text":".","color":"#E80505"},{"score":{"objective":"temp2","name":"$ms"},"color":"#E80505"}," ",{"translate":"ms.bossbar.4.portal.2","fallback":"« 已出现"}]
