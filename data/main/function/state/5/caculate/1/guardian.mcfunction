...
# 最终得分
execute if score @s exp_temp matches 1250.. run tellraw @s [{"translate":"ms.info.end.6","fallback":"总计得分","color":"#C920B0"}," | ",{"score":{"objective":"exp_temp","name":"@s"}}," ",{"text":"[","color":"#7C67FE"},{"text":"E","color":"#8A57FE"},{"text":"X","color":"#9050FE"},{"text":"+","color":"#A03DFF"},{"text":"]","color":"#AE2CFF"}]
execute if score @s exp_temp matches 1000..1249 run tellraw @s [{"translate":"ms.info.end.6","fallback":"总计得分","color":"#C920B0"}," | ",{"score":{"objective":"exp_temp","name":"@s"}}," ",{"text":"[","color":"#778CF7"},{"text":"E","color":"#7B7DE2"},{"text":"X","color":"#806FCE"},{"text":"]","color":"#8364BF"}]
execute if score @s exp_temp matches 800..999 run tellraw @s [{"translate":"ms.info.end.6","fallback":"总计得分","color":"#C920B0"}," | ",{"text":"0","color":"#633654"},{"score":{"objective":"exp_temp","name":"@s"}}," ",{"text":"[","color":"#FB858A"},{"text":"S","color":"#FB8F81"},{"text":"+","color":"#FC9D76"},{"text":"]","color":"#FCA86D"}]
execute if score @s exp_temp matches 640..799 run tellraw @s [{"translate":"ms.info.end.6","fallback":"总计得分","color":"#C920B0"}," | ",{"text":"0","color":"#633654"},{"score":{"objective":"exp_temp","name":"@s"}}," ",{"text":"[","color":"#FBAB7E"},{"text":"S","color":"#FAB876"},{"text":"]","color":"#F8C66D"}]
execute if score @s exp_temp matches 500..639 run tellraw @s [{"translate":"ms.info.end.6","fallback":"总计得分","color":"#C920B0"}," | ",{"text":"0","color":"#633654"},{"score":{"objective":"exp_temp","name":"@s"}}," ",{"text":"[","color":"#7B57CD"},{"text":"A","color":"#8066E2"},{"text":"]","color":"#6C5BCE"}]
execute if score @s exp_temp matches 380..499 run tellraw @s [{"translate":"ms.info.end.6","fallback":"总计得分","color":"#C920B0"}," | ",{"text":"0","color":"#633654"},{"score":{"objective":"exp_temp","name":"@s"}}," ",{"text":"[","color":"#357FFF"},{"text":"B","color":"#2898FE"},{"text":"]","color":"#3088FF"}]
execute if score @s exp_temp matches 280..379 run tellraw @s [{"translate":"ms.info.end.6","fallback":"总计得分","color":"#C920B0"}," | ",{"text":"0","color":"#633654"},{"score":{"objective":"exp_temp","name":"@s"}}," ",{"text":"[","color":"#18D950"},{"text":"C","color":"#3EDD4E"},{"text":"]","color":"#59E04D"}]
execute if score @s exp_temp matches 200..279 run tellraw @s [{"translate":"ms.info.end.6","fallback":"总计得分","color":"#C920B0"}," | ",{"text":"0","color":"#633654"},{"score":{"objective":"exp_temp","name":"@s"}}," ",{"text":"[","color":"#E9BCAD"},{"text":"D","color":"#E4BEBC"},{"text":"]","color":"#E0C0C6"}]
execute if score @s exp_temp matches 100..199 run tellraw @s [{"translate":"ms.info.end.6","fallback":"总计得分","color":"#C920B0"}," | ",{"text":"0","color":"#633654"},{"score":{"objective":"exp_temp","name":"@s"}}," ",{"text":"[","color":"#D0CBC5"},{"text":"F","color":"#DDDBD5"},{"text":"]","color":"#E4E2DD"}]
execute if score @s exp_temp matches 10..99 run tellraw @s [{"translate":"ms.info.end.6","fallback":"总计得分","color":"#C920B0"}," | ",{"text":"00","color":"#633654"},{"score":{"objective":"exp_temp","name":"@s"}}," ",{"text":"[","color":"#D0CBC5"},{"text":"F","color":"#DDDBD5"},{"text":"]","color":"#E4E2DD"}]
execute if score @s exp_temp matches 0..9 run tellraw @s [{"translate":"ms.info.end.6","fallback":"总计得分","color":"#C920B0"}," | ",{"text":"000","color":"#633654"},{"score":{"objective":"exp_temp","name":"@s"}}," ",{"text":"[","color":"#D0CBC5"},{"text":"F","color":"#DDDBD5"},{"text":"]","color":"#E4E2DD"}]