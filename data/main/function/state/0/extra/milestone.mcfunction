...
execute unless score @s extra.milestone matches 2.. run item replace entity @s enderchest.12 with red_stained_glass_pane[custom_name='{"translate":"ms.milestone.2","fallback":"β","italic":false}',lore=['[{"translate":"ms.lore.locked","fallback":"🔒 未解锁","color":"red","italic":false}]','""','{"translate":"ms.milestone.mvp","fallback":"· 在 %s 局游戏中成为全场最佳","with":["1"],"color":"gray","italic":false}'],hide_additional_tooltip={}] 2
...
execute unless score @s extra.milestone matches 3.. run item replace entity @s enderchest.13 with blaze_rod[custom_name='{"translate":"ms.weapon.4","fallback":"散炽棍","italic":false}',lore=['[{"translate":"ms.lore.locked","fallback":"🔒 未解锁","color":"red","italic":false}]','""','{"translate":"ms.milestone.down","fallback":"· 累计击倒 %s 次灵魂","with":["5"],"color":"gray","italic":false}','{"translate":"ms.milestone.adv","fallback":"· 达成进度 %s","with":[{"translate":"ms.adv.kill.2","fallback":"祛灵烈斩"}],"color":"gray","italic":false}'],hide_additional_tooltip={}] 3
...
execute unless score @s extra.milestone matches 4.. run item replace entity @s enderchest.14 with red_stained_glass_pane[custom_name='{"translate":"ms.milestone.4","fallback":"γ","italic":false}',lore=['[{"translate":"ms.lore.locked","fallback":"🔒 未解锁","color":"red","italic":false}]','""','{"translate":"ms.milestone.revive","fallback":"· 累计胜利 %s 次","with":["7"],"color":"gray","italic":false}','{"translate":"ms.milestone.record","fallback":"· 短期分最高达到过 %s","with":["4500"],"color":"gray","italic":false}'],hide_additional_tooltip={}] 4
...
execute unless score @s extra.milestone matches 5.. run item replace entity @s enderchest.15 with red_stained_glass_pane[custom_name='{"translate":"ms.milestone.5","fallback":"Ω","italic":false}',lore=['[{"translate":"ms.lore.locked","fallback":"🔒 未解锁","color":"red","italic":false}]','""','{"translate":"ms.milestone.mvp","fallback":"· 在至少 %s 局游戏中成为全场最佳","with":["5"],"color":"gray","italic":false}','{"translate":"ms.milestone.level","fallback":"· 游戏等级达到 Lv.%s","with":["25"],"color":"gray","italic":false}'],hide_additional_tooltip={}] 5
...
execute unless score @s extra.milestone matches 6.. run item replace entity @s enderchest.16 with amethyst_cluster[custom_name='{"translate":"ms.headset.3","fallback":"紫水晶皇冠","italic":false}',lore=['[{"translate":"ms.lore.locked","fallback":"🔒 未解锁","color":"red","italic":false}]','""','{"translate":"ms.milestone.single_rating","fallback":"· 单局表现分纪录达到 %s","with":["700"],"color":"gray","italic":false}','{"translate":"ms.milestone.kill","fallback":"· 累计击杀 %s 次灵魂","with":["30"],"color":"gray","italic":false}','{"translate":"ms.milestone.time","fallback":"· 累计游玩 %s 以上","with":["90:00"],"color":"gray","italic":false}'],hide_additional_tooltip={}] 6
