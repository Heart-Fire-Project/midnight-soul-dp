...
function base:merge_sign {x:"1",y:"1",z:"3",glow:"1",color:"orange",trans_2:"ms.sign.major_update",trans_3:"ms.sign.2",fallb_2:"[重大更新]",fallb_3:"2.0 » 从零再启程",command:"trigger interact_check set 2"}
