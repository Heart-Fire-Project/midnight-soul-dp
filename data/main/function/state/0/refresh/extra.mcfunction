...
function base:merge_sign {x:"-990",y:"0",z:"-1011",glow:"1",color:"white",trans_2:"",trans_3:"ms.particle.1",fallb_2:"01",fallb_3:"午夜繁星",command:"trigger interact_check set 4101"}
function base:merge_sign {x:"-989",y:"0",z:"-1011",glow:"1",color:"white",trans_2:"",trans_3:"ms.particle.2",fallb_2:"02",fallb_3:"氤氲灵气",command:"trigger interact_check set 4102"}
function base:merge_sign {x:"-988",y:"0",z:"-1011",glow:"1",color:"white",trans_2:"",trans_3:"ms.particle.3",fallb_2:"03",fallb_3:"霜凝冰痕",command:"trigger interact_check set 4103"}
function base:merge_sign {x:"-987",y:"0",z:"-1011",glow:"1",color:"white",trans_2:"",trans_3:"ms.particle.4",fallb_2:"04",fallb_3:"点灯施援",command:"trigger interact_check set 4104"}
function base:merge_sign {x:"-987",y:"0",z:"-1010",glow:"1",color:"white",trans_2:"",trans_3:"ms.particle.5",fallb_2:"05",fallb_3:"灵迹随踪",command:"trigger interact_check set 4105"}
function base:merge_sign {x:"-987",y:"0",z:"-1009",glow:"1",color:"white",trans_2:"",trans_3:"ms.particle.6",fallb_2:"06",fallb_3:"万象环身",command:"trigger interact_check set 4106"}
function base:merge_sign {x:"-987",y:"0",z:"-1008",glow:"1",color:"white",trans_2:"",trans_3:"ms.particle.7",fallb_2:"07",fallb_3:"绚彩粉墨",command:"trigger interact_check set 4107"}
function base:merge_sign {x:"-987",y:"0",z:"-1007",glow:"1",color:"white",trans_2:"",trans_3:"ms.particle.8",fallb_2:"08",fallb_3:"桃起樱落",command:"trigger interact_check set 4108"}
function base:merge_sign {x:"-987",y:"0",z:"-1006",glow:"1",color:"white",trans_2:"",trans_3:"ms.particle.9",fallb_2:"09",fallb_3:"双生魂焰",command:"trigger interact_check set 4109"}
...
function base:merge_sign {x:"-998",y:"0",z:"-991",glow:"1",color:"white",trans_2:"",trans_3:"ms.headset.1",fallb_2:"01",fallb_3:"鬼亦独角兽",command:"trigger interact_check set 4301"}
...
function base:merge_sign {x:"-1000",y:"0",z:"-991",glow:"1",color:"white",trans_2:"",trans_3:"ms.headset.3",fallb_2:"03",fallb_3:"紫水晶皇冠",command:"trigger interact_check set 4303"}
...
summon item_display -999 -0.48 -990 {Tags:["extra_entity"],item:{id:"player_head",components:{profile:BanGDream_Tomori}},billboard:"fixed",interpolation_duration:0,item_display:"head",transformation:{scale:[0.9f,0.9f,0.9f],translation:[0f,0f,0f],right_rotation:[0f,1f,0f,1f],left_rotation:[0f,-1f,0f,1f]}}
...
function base:merge_sign {x:"-1001",y:"0",z:"-1007",glow:"1",color:"light_gray",trans_2:"",trans_3:"ms.text.0",fallb_2:"00",fallb_3:"趋光",command:"trigger interact_check set 4400"}
function base:merge_sign {x:"-1001",y:"0",z:"-1008",glow:"1",color:"white",trans_2:"",trans_3:"ms.text.1",fallb_2:"01",fallb_3:"溯回",command:"trigger interact_check set 4401"}
function base:merge_sign {x:"-1001",y:"0",z:"-1009",glow:"1",color:"white",trans_2:"",trans_3:"ms.text.2",fallb_2:"02",fallb_3:"无拘",command:"trigger interact_check set 4402"}
