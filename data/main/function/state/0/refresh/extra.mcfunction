...
summon text_display -992 -0.85 -1001 {Tags:["extra_entity"],text:'[{"translate":"ms.extra.query_desc","fallback":"今天，你掉分了吗？","color":"white"}]',background:0,billboard:"center",alignment:"center",line_width:240,interpolation_duration:0,transformation:{scale:[0.4f,0.4f,0.4f],translation:[0f,0f,0f],right_rotation:[0f,0f,0f,1f],left_rotation:[0f,0f,0f,1f]}}
...
function base:merge_sign {x:"-991",y:"0",z:"-1011",glow:"1",color:"light_gray",trans_2:"",trans_3:"ms.particle.0",fallb_2:"--",fallb_3:"无粒子效果",command:"trigger interact_check set 3100"}
function base:merge_sign {x:"-990",y:"0",z:"-1011",glow:"1",color:"white",trans_2:"",trans_3:"ms.particle.1",fallb_2:"Lv.10",fallb_3:"午夜繁星",command:"trigger interact_check set 3101"}
function base:merge_sign {x:"-989",y:"0",z:"-1011",glow:"1",color:"white",trans_2:"",trans_3:"ms.particle.2",fallb_2:"Lv.25",fallb_3:"氤氲灵气",command:"trigger interact_check set 3102"}
function base:merge_sign {x:"-988",y:"0",z:"-1011",glow:"1",color:"white",trans_2:"",trans_3:"ms.particle.3",fallb_2:"Lv.40",fallb_3:"凝结冰痕",command:"trigger interact_check set 3103"}
function base:merge_sign {x:"-987",y:"0",z:"-1011",glow:"1",color:"white",trans_2:"",trans_3:"ms.particle.4",fallb_2:"Lv.55",fallb_3:"点灯施援",command:"trigger interact_check set 3104"}
function base:merge_sign {x:"-987",y:"0",z:"-1010",glow:"1",color:"white",trans_2:"",trans_3:"ms.particle.5",fallb_2:"Lv.70",fallb_3:"灵迹随踪",command:"trigger interact_check set 3105"}
function base:merge_sign {x:"-987",y:"0",z:"-1009",glow:"1",color:"white",trans_2:"",trans_3:"ms.particle.6",fallb_2:"Lv.85",fallb_3:"万象环身",command:"trigger interact_check set 3106"}
function base:merge_sign {x:"-987",y:"0",z:"-1008",glow:"1",color:"white",trans_2:"",trans_3:"ms.particle.7",fallb_2:"Lv.100",fallb_3:"绚彩粉墨",command:"trigger interact_check set 3107"}
function base:merge_sign {x:"-987",y:"0",z:"-1007",glow:"1",color:"white",trans_2:"",trans_3:"ms.particle.8",fallb_2:"Lv.114",fallb_3:"桃起樱落",command:"trigger interact_check set 3108"}
function base:merge_sign {x:"-987",y:"0",z:"-1006",glow:"1",color:"white",trans_2:"",trans_3:"ms.particle.9",fallb_2:"Lv.128",fallb_3:"焰火不熄",command:"trigger interact_check set 3109"}
...
summon text_display -991 -0.85 -996 {Tags:["extra_entity"],text:'[{"translate":"ms.extra.weappon_desc","fallback":"高级武器可提供高达 0.00% 的加成","color":"white"}]',background:0,billboard:"center",alignment:"center",line_width:240,interpolation_duration:0,transformation:{scale:[0.4f,0.4f,0.4f],translation:[0f,0f,0f],right_rotation:[0f,0f,0f,1f],left_rotation:[0f,0f,0f,1f]}}
function base:merge_sign {x:"-987",y:"0",z:"-996",glow:"1",color:"light_gray",trans_2:"",trans_3:"ms.weapon.0",fallb_2:"00",fallb_3:"祛灵刃",command:"trigger interact_check set 3200"}
function base:merge_sign {x:"-987",y:"0",z:"-995",glow:"1",color:"white",trans_2:"",trans_3:"ms.weapon.1",fallb_2:"01",fallb_3:"祛灵刃 α",command:"trigger interact_check set 3201"}
function base:merge_sign {x:"-987",y:"0",z:"-994",glow:"1",color:"white",trans_2:"",trans_3:"ms.weapon.2",fallb_2:"02",fallb_3:"祛灵刃 β",command:"trigger interact_check set 3202"}
function base:merge_sign {x:"-987",y:"0",z:"-993",glow:"1",color:"white",trans_2:"",trans_3:"ms.weapon.3",fallb_2:"03",fallb_3:"破魂锤",command:"trigger interact_check set 3203"}
function base:merge_sign {x:"-987",y:"0",z:"-992",glow:"1",color:"white",trans_2:"",trans_3:"ms.weapon.4",fallb_2:"04",fallb_3:"散炽棍",command:"trigger interact_check set 3204"}
...
function base:merge_sign {x:"-997",y:"0",z:"-991",glow:"1",color:"light_gray",trans_2:"",trans_3:"ms.headset.0",fallb_2:"--",fallb_3:"空气",command:"trigger interact_check set 3300"}
function base:merge_sign {x:"-998",y:"0",z:"-991",glow:"1",color:"white",trans_2:"",trans_3:"ms.headset.1",fallb_2:"01",fallb_3:"鬼或独角兽",command:"trigger interact_check set 3301"}
function base:merge_sign {x:"-999",y:"0",z:"-991",glow:"1",color:"white",trans_2:"",trans_3:"ms.headset.2",fallb_2:"02",fallb_3:"战地通信员",command:"trigger interact_check set 3302"}
function base:merge_sign {x:"-1000",y:"0",z:"-991",glow:"1",color:"white",trans_2:"",trans_3:"ms.headset.3",fallb_2:"03",fallb_3:"紫水晶皇冠",command:"trigger interact_check set 3303"}
summon item_display -998 -0.48 -990 {Tags:["extra_entity"],item:{id:"player_head",components:{profile:Roserua}},billboard:"fixed",interpolation_duration:0,item_display:"head",transformation:{scale:[0.9f,0.9f,0.9f],translation:[0f,0f,0f],right_rotation:[0f,1f,0f,1f],left_rotation:[0f,-1f,0f,1f]}}
...
summon text_display -997 -0.85 -1007 {Tags:["extra_entity"],text:'[{"translate":"ms.extra.text_desc","fallback":"天啊！翻译组最讨厌的一集！","color":"white"}]',background:0,billboard:"center",alignment:"center",line_width:240,interpolation_duration:0,transformation:{scale:[0.4f,0.4f,0.4f],translation:[0f,0f,0f],right_rotation:[0f,0f,0f,1f],left_rotation:[0f,0f,0f,1f]}}
function base:merge_sign {x:"-1001",y:"0",z:"-1007",glow:"1",color:"light_gray",trans_2:"",trans_3:"ms.text.0",fallb_2:"00",fallb_3:"趋光",command:"trigger interact_check set 3400"}
function base:merge_sign {x:"-1001",y:"0",z:"-1008",glow:"1",color:"white",trans_2:"",trans_3:"ms.text.1",fallb_2:"01",fallb_3:"溯回",command:"trigger interact_check set 3401"}
function base:merge_sign {x:"-1001",y:"0",z:"-1009",glow:"1",color:"white",trans_2:"",trans_3:"ms.text.2",fallb_2:"02",fallb_3:"无拘",command:"trigger interact_check set 3402"}
