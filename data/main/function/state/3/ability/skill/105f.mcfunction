...
execute unless entity @a[team=soul,distance=..2] run scoreboard players remove @s temp.hit 1
execute as @a[team=soul,distance=..2] run damage @s 10
execute as @a[team=soul,distance=..2] run function main:lib/player/hurt
