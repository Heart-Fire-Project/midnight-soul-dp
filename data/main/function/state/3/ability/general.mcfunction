...
execute at @a[scores={talent_1=4},tag=talent_1_on,team=guardian] run effect give @a[team=soul,distance=40..] glowing 1 0
execute at @a[scores={talent_2=4},tag=talent_2_on,team=guardian] run effect give @a[team=soul,distance=40..] glowing 1 0
