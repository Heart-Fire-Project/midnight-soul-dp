...
# 生成新碎片
$execute at @e[tag=marker_blue,tag=!no_summon,sort=random,limit=$(num)] run summon item ~ ~0.2 ~ {Tags:[game_entity,new_blue,blue],Item:{id:"echo_shard",count:1},PickupDelay:32767s,Age:-32768s,NoGravity:1b}
