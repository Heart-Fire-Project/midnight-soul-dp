...
execute if score $chest_current temp < $chest_max temp run scoreboard players set $3_chest countdown 180
execute if score $chest_current temp < $chest_max temp if score $echo data matches 4 run scoreboard players set $3_chest countdown 60