...
playsound minecraft:block.sculk_shrieker.shriek player @a 0 1000000 0 1000000
...
# 可以调整的就调整基础速度
execute as @a[team=guardian,scores={state=0}] run attribute @s generic.movement_speed base set 0.16