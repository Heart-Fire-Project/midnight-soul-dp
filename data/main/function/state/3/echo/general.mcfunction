...
execute if score $echo data matches 1 if score $alive data matches ..2 if score $3_echo countdown matches 0.. run function main:state/3/echo/01f
...
execute if score $echo data matches 5 if score $3_echo countdown matches 5 store result storage ms:temp num short 1 run data get storage ms:map shard_summon 0.2
