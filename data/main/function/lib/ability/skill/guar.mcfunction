...
tellraw @s[scores={skill=4}] [{"translate":"ms.skill.104.desc","fallback":"为一个随机的灵魂宝物盒附加%s效果，若没有未被诅咒的灵魂宝物盒则生成 2 个；技能施放时在 8 秒内移速 +60%，场上每有一个被诅咒的灵魂宝物盒延长 8 秒时间","with":[{"translate":"ms.tooltip.curse","fallback":"诅咒","underlined":true,"hoverEvent":{"action":"show_text","contents":[{"translate":"ms.tooltip,curse","fallback":"诅咒","color":"red"},"\n",{"translate":"ms.tootip.curse.detail","fallback":"灵魂经过时自身发光且移速 -15%\n守卫者经过时全体灵魂发光且自身移速 +20%\n开启该灵魂宝物盒时获取更强的上述效果","color":"white"}]}}]}]
